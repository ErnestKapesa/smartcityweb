...
document.querySelectorAll('.feature-card, .product-card, .tech-item, .stat-box').forEach(el => {
    el.style.opacity = '0';
...
window.addEventListener('scroll', () => {
    ...
    const parallaxElements = document.querySelectorAll('.hero-content, .page-header-content');
...
const revealElements = document.querySelectorAll('.feature-card, .product-card, .tech-card, .value-card');
